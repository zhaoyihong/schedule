...
{
	cout << "usage :" << endl;
	cout << binname << " path total maxloops bin_names" << endl;
}
...
int main(int argc,char *argv[])
{
    ...
    for(int i=0;i<total;++i)
    {
        deny.bin_indexs.push_back(atoi(argv[4+i]));        
    }
    
    //printArray(deny.bin_indexs,deny.bin_indexs.size());
